...
///
/// The [UnitController] class extends [ValueNotifier] and is used to track a numeric value that represents
...
///
/// [UnitController] is designed to be used with widgets or other components that need to react to changes
/// in a unit's value, such as updating the ruler position or displaying the current measurement value.
class UnitController extends ValueNotifier<num> {
  /// Creates a [UnitController] with an initial value.
  ///
  ...
  UnitController({num value = 0}) : super(value);
