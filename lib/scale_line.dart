...
///
/// The [UnitIntervalStyle] class allows you to customize the appearance of an interval on the ruler.
...
class UnitIntervalStyle {
  ...
  /// Creates a [UnitIntervalStyle] with the specified [color], [width], and [height].
